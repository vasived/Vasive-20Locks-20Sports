    ...
    const samplePicks = [
      {
        ...
        side: "Over",
        analysis_short:
          "LeBron has scored over 25.5 points in 7 of his last 10 games. The matchup against a weak defense favors the over.",
        confidence_pct: 75,
        odds: "-110",
      ...
      },
      {
        ...
        side: "Over",
        analysis_short:
          "Curry is averaging 4.2 threes per game at home this season. Expect him to let it fly against this pace-up matchup.",
        confidence_pct: 68,
        odds: "+100",
        sportsbook: "FanDuel",
        created_by_user_id: adminUserId,
      },
      {
        ...
        side: "Under",
        analysis_short:
          "Tatum faces a tough defensive matchup and has gone under this number in 3 straight games.",
        analysis_long:
          "Advanced metrics show Tatum struggles against top-10 defenses, shooting 42% from the field vs 48% against average defenses. The opponent ranks 3rd in defensive rating and has held wings to 2.1 points below their season average. Tatum also played heavy minutes last game and may see reduced usage.",
        confidence_pct: 82,
        stake_pct: 0.025,
        odds: "-105",
        sportsbook: "Caesars",
      ...
      },
      {
        ...
        side: "Over",
        analysis_short:
          "Jokic has dominated the boards against this opponent historically and should feast tonight.",
        analysis_long:
          "Jokic averages 14.8 rebounds against teams that rank in the bottom 10 in rebounding rate. Tonight's opponent ranks 28th in defensive rebounding and allows 13.2 rebounds per game to centers. Pace-up game environment with a 235.5 total suggests plenty of rebounding opportunities.",
        confidence_pct: 89,
        stake_pct: 0.04,
        odds: "-120",
        sportsbook: "BetMGM",
    ...
    for (const pick of samplePicks) {
      ...
      `,
        [
          ...
          pick.side,
          pick.analysis_short,
          pick.analysis_long || null,
          pick.confidence_pct,
          pick.stake_pct,
          pick.odds,
          pick.sportsbook,
          pick.created_by_user_id,
        ],
      );
    }
