          ...
          <Card className="border-brand-purple/20 bg-brand-purple/5">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                ...
                Upgrade now to access advanced analytics and expert picks.
              </p>
...
export function RequirePremium({ children }: { children: React.ReactNode }) {
  return <ProtectedRoute requireAuth requirePremium>{children}</ProtectedRoute>;
}

export function RequireAdmin({ children }: { children: React.ReactNode }) {
  return <ProtectedRoute requireAuth requireAdmin>{children}</ProtectedRoute>;
}
